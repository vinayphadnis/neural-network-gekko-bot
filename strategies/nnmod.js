...
var strategy = {
  ...
  init : function() {
    ...
    //mycode
    this.RSI = new RSI(setInterval(function () {
      return 15;
    }, 10))

    let layers = [
      {type:'input', out_sx:1, out_sy:1, out_depth: 1},
      {type:'fc', num_neurons: this.layer_neurons_1, activation: this.layer_activation},
      {type:'fc', num_neurons: this.layer_neurons_2, activation: this.layer_activation},
